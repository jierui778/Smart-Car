...
//	Pespective(ipts0,ipts0_num,ipts_out);
    ...
    {
        ips200_draw_line(0,200,ipts0[i][0],ipts0[i][1]+200,RGB565_GREEN);
    }
    for(i=0;i<ipts1_num;i++)
    {
        ips200_draw_line(160,200,ipts1[i][0],ipts1[i][1]+200,RGB565_RED);
    }
     ...
     ips200_show_int(203,200,rpts0b[0][0],3);
	 ips200_show_int(203,220,rpts0b[0][1],3);
	 ips200_show_int(203,240,rpts1b[20][0],3);
	 ips200_show_int(203,260,rpts1b[20][1],3);
...
//     resample_points(rpts1b, rpts1b_num, rpts1s, &rpts1s_num, sample_dist * pixel_per_meter);
    ...
    for(int i = 0 ; i < rpts0s_num ; i++)//显示左边线
    {
        ...
        x = func_limit_ab (rpts0b[i][0] , -	200,200);
        y = func_limit_ab (rpts0b[i][1] , 0,  199);

        ips200_draw_point(x/2  + 100, 200 - y , RGB565_GREEN); // 左线为绿色 
    }
